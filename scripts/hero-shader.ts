...
/* ========== MeshGradient shader (GLSL 1.0, ported from @paper-design/shaders) ========== */
...
const fragmentShader = `
  ...
  vec2 getPosition(int i, float t) {
    float fi = float(i);
    float a = fi * .37;
    float b = .6 + fract(fi / 3.) * .9;
    float c = .8 + fract((fi + 1.0) / 4.);
...
/* Dark theme colors: black → dark gray → medium gray → white highlight */
const colors = [
  new THREE.Vector4(0.0,  0.0,  0.0,  1.0),  // #000000
  new THREE.Vector4(0.05, 0.05, 0.05, 1.0),  // #0d0d0d
  new THREE.Vector4(0.10, 0.10, 0.10, 1.0),  // #1a1a1a
  new THREE.Vector4(1.0,  1.0,  1.0,  1.0),  // #ffffff highlight
];
